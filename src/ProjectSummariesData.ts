...
export const projectSummaries: ProjectSummaryNarrative[] = [
  ...
  {
    publishedUrl: 'https://snerks.github.io/chart-01-app/',
    imageUrl: '/images/chart-01-app.300.png',
    title: 'React BESS Monitoring System',
    description: 'A Battery Energy Storage System Monitoring app.',
    technologies: ['React', 'Vite', 'TypeScript', 'Recharts'],
  },
  {
